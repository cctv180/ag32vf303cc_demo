...
extern uint32_t __rodata_vma;
extern uint32_t __rodata_lma;
...
void _init(void)
{
  ...
  memcpy(&__rodata_vma,    &__rodata_lma,    (int)&__rodata_size);
...
{
  return vprintfmt((void*)putchar, 0, fmt, ap, 0);
}
