...
static inline uint32_t GPIO_GetRawIntStatus(GPIO_TypeDef *gpio) { return gpio->GpioRIS; }
static inline uint32_t GPIO_GetMaskedIntStatus(GPIO_TypeDef *gpio) { return gpio->GpioMIS; }
