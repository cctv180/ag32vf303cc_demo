...
static inline void SYS_SetAlarmWakeupEdge(SYS_WakeupEdgeTypeDef edge) { SYS_SetWakeupEdgeByID(SYS_WAKEUP_ALARM_ID, edge); }
static inline uint32_t SYS_ClearPendingWakeups(void) { uint32_t val = SYS->WKP_PENDING; SYS->WKP_PENDING = val; return val; }
